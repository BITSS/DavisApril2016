...
\title[Publication Bias, P-hacking, and Pre-Registration] % (optional, use only with long paper titles)
{Publication Bias, P-hacking, and Pre-Registration}

\subtitle
{}

\author[Christensen] % (optional, use only with lots of authors)
{Garret~Christensen\inst{}}
...
{UC Davis ISS, April 2016\\
Slides available online at \url{https://github.com/BITSS/DavisApril2016}}
...
\begin{itemize}
\item
Also called fishing, researcher degrees of freedom, specification searching, or data-mining.
\item
Definition: flexibility in data analysis allows portrayal of \textit{anything} as below an arbitrary p-value threshold; significance loses its meaning.
\item
...
\item
Inordinately many .049 p-values, and inordinately few .051's; 10-20\%. (Brodeur et al 2015, ``Star Wars'')
\item 
